        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(builder.ConnectionString))
                {
                    ...
                    String sql = "DROP DATABASE IF XISTS [SampleDB]; CREATE DATABASE [SampleDB]";
                    ...
                    using (SqlCommand command = new SqlCommand(sql, connection))
                    {
                        ...
                        Console.WriteLine(rowsAfftected + "row(s) inserted");
                    }
                    ...
                    Console.WriteLine("Deleting user" + userToDelete + "', press and ket to continue...");
                    Console.ReadKey(true);
                    sb.Clear();
                    ...
                    //READ demo
                    Console.WriteLine("Reading data from table, press any key to conitnue...");
                    Console.ReadKey(true);
